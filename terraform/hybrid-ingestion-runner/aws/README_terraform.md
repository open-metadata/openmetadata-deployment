...
| <a name="input_environment"></a> [environment](#input\_environment) | The environment name where the resources will be deployed. Must be unique within the AWS Region. | `string` | n/a | yes |
