...
| <a name="input_release_version"></a> [release\_version](#input\_release\_version) | The Hybrid Ingestion Runner version to deploy. | `string` | `"1.8.2"` | no |
