...
| <a name="input_argowf_identity_mode"></a> [argowf_identity_mode](#input\_argowf\_identity\_mode) | The identity mode for Argo Workflows pods. Options: `irsa` or `pod_identity`. | `string` | `"irsa"` | no |
| <a name="input_collate_auth_token"></a> [collate\_auth\_token](#input\_collate_auth_token) | The token used to authenticate with the Collate server. | `string` | n/a | yes |
...
| <a name="input_ingestion_identity_mode"></a> [ingestion_identity_mode](#input\_ingestion_identity_mode) | The identity mode for ingestion pods. Options: `irsa` or `pod_identity`. | `string` | `"irsa"` | no |
