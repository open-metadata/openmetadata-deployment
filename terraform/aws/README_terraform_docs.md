...
| <a name="input_app_version"></a> [app\_version](#input\_app\_version) | The version of the OpenMetadata application to deploy. | `string` | `"1.8.8"` | no |
...
| <a name="input_docker_image_name"></a> [docker\_image\_name](#input\_docker\_image\_name) | Full path of the server Docker image name, excluding the tag. | `string` | `"1.8.86679784.dkr.ecr.eu-west-1.amazonaws.com/collate-customers-eu-west-1"` | no |
...
| <a name="input_ingestion_image_name"></a> [ingestion\_image\_name](#input\_ingestion\_image\_name) | Full path of the ingestion Docker image name, excluding the tag. | `string` | `"1.8.86679784.dkr.ecr.eu-west-1.amazonaws.com/collate-customers-ingestion-eu-west-1"` | no |
