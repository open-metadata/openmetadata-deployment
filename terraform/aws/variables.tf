...
variable "docker_image_name" {
  type        = string
  default     = "1.8.56679784.dkr.ecr.eu-west-1.amazonaws.com/collate-customers-eu-west-1"
...
variable "ingestion_image_name" {
  type        = string
  default     = "1.8.56679784.dkr.ecr.eu-west-1.amazonaws.com/collate-customers-ingestion-eu-west-1"
